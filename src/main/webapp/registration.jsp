...
<body>
	...
	if (status=="newfail"){
		swal("Sorry","Not a registered user","error")
	}
	
	if (status=="invalidname"){
		swal("Sorry","Invalid username entered","error")
	}
	
	if (status=="invalidpwd"){
		swal("Sorry","Invalid password entered","error")
	}
	
	if (status=="invalidrpwd"){
		swal("Sorry","Re-entered password does not match","error")
	}
